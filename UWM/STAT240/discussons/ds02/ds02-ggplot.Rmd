...
Transit
We generally see the planet mass is directly related to the radius of th planets, i.e. as the radius increases, the mass of the plant increases.
14 earth radii appx.
...
```{r}
## COMPLETE CODE TO MAKE THIS PLOT
ggplot( planets, aes(x = log10(mass)) ) + geom_histogram(fill = "white", color = "black") +
