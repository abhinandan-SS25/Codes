//////////////// FILE HEADER //////////////////////////
//
// Title: File implementing the Badger Class
...
public class Badger {
  ...
  /**
   * Checks if the mouse is over the instantiated badger object
   * 
   * @return true if the mouse is over the badger object (i.e. over the image of the badger), fals0e
   *         otherwise
   */
  ...
  /**
   * Returns a reference to the static data field of Badger class that has the type PApplet
   * processing
   * 
   * @return The reference to the static data field of Badger class of type PApplet processing
   */
